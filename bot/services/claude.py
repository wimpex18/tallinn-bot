...
async def query_claude(
    ...
    _STATIC_SYSTEM = (
        ...
        'Если видишь "[Погода в ... — актуальные данные от wttr.in]" — это реальные данные '
        'погоды, полученные только что. Перескажи их естественно и разговорно, '
        'не упоминая wttr.in и не говоря что ты "искал" или "смотрел". '
        'Просто сообщи погоду как будто ты её знаешь.\n\n'
